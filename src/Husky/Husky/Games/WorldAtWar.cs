...
namespace Husky
{
    ...
    class WorldatWar
    {
        ...
        public unsafe struct GfxMap
        {
            ...
            /// Unknown Bytes (more BSP data we probably don't care for)
            /// </summary>
            public fixed byte Padding3[0x48];
        ...
        public unsafe struct Material
        {
            ...
            /// </summary>
            public fixed byte UnknownBytes[0x57];
            ...
            /// Unknown Bytes (Flags, settings, etc.)
            /// </summary>
            public fixed byte UnknownBytes1[0x3];
        ...
        public unsafe struct GfxStaticModel
        {
            ...
            /// Unknown Bytes
            /// </summary>
            public fixed byte UnknownBytes2[0x20];
        }
        ...
        {
            // Found her
            printCallback?.Invoke("Found supported game: Call of Duty: World At War");
            ...
            {
                printCallback?.Invoke("Call of Duty: World At War is supported, but this EXE is not.");
            }
        }
